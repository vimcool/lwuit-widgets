...
public class Indicator extends Component implements IndicatorEventListener {
    ...
    public void setMaxIndicatorsPerGroup(int maxIndicatorsPerGroup) {
        this.maxTimelineItems = maxIndicatorsPerGroup;
    }
    ...
    public void setType(int type) {
    	//FIXME Patch to set the type for IMAGES always, will change when RAW mode is implemented
        if(type != TYPE_IMAGES) {
            type = TYPE_IMAGES;
        }
        this.type = type;
    ...
    public void setVerticalAlignment(int valign) {
    	//FIXME Patch to set the vertical aligment to CENTER always, will change when other vAlignments are implemented
